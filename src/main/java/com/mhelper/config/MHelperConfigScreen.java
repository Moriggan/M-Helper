...
public class MHelperConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        y += spacing;
        addDrawableChild(CyclingButtonWidget.<MHelperConfig.HudPalette>builder(value -> Text.literal(value.name().toLowerCase().replace('_', ' ')))
    ...
    private abstract static class DoubleSliderWidget extends SliderWidget {
        private final double min;
        private final double max;
        private final Text label;

        protected DoubleSliderWidget(int x, int y, int width, int height, Text text, double value, double min, double max) {
